  ...
  <v-app :theme="theme">
      ...
      <RouterLink :to="{ name: 'home' }" class="link home">
        <div class="container-logo-svg">
          <svg viewBox="0 -1 300 120" class="css-1j8o68f logo-svg">
            ...
            <g id="SvgjsG23286" featurekey="symbolFeature-0"
              transform="matrix(0.7838760802149753,0,0,0.7838760802149753,-11,-11.974265123009655)" fill="#ff6600"
              data-darkreader-inline-fill="" style="--darkreader-inline-fill: #c24e00">
              <g xmlns="http://www.w3.org/2000/svg">
                <path fill="#ff6600"
                  ...
                  data-darkreader-inline-fill="" style="--darkreader-inline-fill: #c24e00"></path>
              </g>
            </g>
            <g id="SvgjsG23287" featurekey="nameFeature-0"
              transform="matrix(1.8240151053652593,0,0,1.8240151053652593,66.1,-17.83148647549759)" fill="#4a4a4a"
              data-darkreader-inline-fill="" style="--darkreader-inline-fill: #35393c">
              <path
            ...
            <g id="SvgjsG23288" featurekey="nameFeature-1"
              transform="matrix(1.7163484752497165,0,0,1.7163484752497165,0,49.82748249057343)" fill="#4a4a4a"
              data-darkreader-inline-fill="" style="--darkreader-inline-fill: #35393c">
              <path
    ...
    <v-footer color="limit" :style="{
      ...
      <div class="footer">
        ...
        <div class="links" v-for="(developer, i) in developers.slice(1)" :key="i">
          <a :href="developer.github" class="github" target="_blank">
            <v-avatar class="ma-1 avatar" size="50" rounded="5"><v-img :src="developer.avatar"></v-img>
            </v-avatar>
            <div class="name">
              <h3>
                {{ developer.name }}
