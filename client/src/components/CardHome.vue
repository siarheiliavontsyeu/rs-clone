<template>
  <div>
    <v-card v-if="movieCard.isItemsReady" class="card w-100" @mousemove="someMethod">
      <div class="mouse-parallax-bg" :style="{
        position: 'absolute',
      ...
      <div class="card-body">
        <div class="container-logo d-flex justify-center align-center" :style="{
          height: '100%',
          width: '100%',
          maxHeight: '100px',
        }">
  ...
  height: '52px',
    ...
    <v-card v-else class="card w-100">
      ...
      <div class="card-body" :style="{
        ...
        <v-card-actions>
          <v-btn rounded="pill" color="white" size="large" prepend-icon="mdi-play" :style="{
            background: 'linear-gradient(135deg, #f50 69.93%, #d6bb00)',
            fontSize: '16px',
            padding: '0px 15px',
            height: '52px',
