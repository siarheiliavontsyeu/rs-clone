<template>
    <transition name="slide-fade">
        <v-container class="submit-review" v-if="!writeView">
            ...
            <div class="review">
                ...
                <div class="body">
                    <v-select label="Тип рецензии" variant="outlined" v-model="reviewType" :items="reviewTypes" color="#f50"
                        item-title="title" item-value="value"></v-select>
                    <v-text-field v-model="title" label="Заголовок" color="#f50" variant="outlined"></v-text-field>
                    <v-textarea v-model="description" auto-grow :maxlength="200" :counter="200" color="#f50" :rules="rules"
    ...
    <v-snackbar v-model="noDescriptionLength" color="#f50" timeout="4000" location="bottom left" variant="tonal">
